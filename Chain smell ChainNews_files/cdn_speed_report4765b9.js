...
var o=i?(a+1)/(i+1)*paragraphList.length:paragraphList.length/2,_=n?e.position_index:Math.floor(o)-1;
_=0>_?0:_;
...
if(a.length)for(var n=0;n<a.length;n++)if(a[n].exp_para&&a[n].exp_para.length)for(var o=0;o<a[n].exp_para.length;o++)if(a[n].exp_para[o].name===t)return a[n].exp_para[o].value;
}
}
function isUseFrame(){
...
var e=arguments.length<=0||void 0===arguments[0]?[]:arguments[0],t=0,a=[],i=[],n=["904"];
for(var o in e){
var _=e[o],p=isUseFrame(_,"widget_gray_biz_intext_iframe")&&_.pos_type===AD_POS.POS_MID,r=isUseFrame(_,"widget_gray_biz_bottom_iframe");
r=r&&_.pos_type===AD_POS.POS_BOTTOM,r=r&&!isVideoSharePageOnlyAd&&"5"!==window.item_show_type,
r=r&&CrtManager.CRT_CONF[_.crt_size],r=r||n.indexOf(_.crt_size)>-1,p&&t++,p||utils.isUseAppMsgAd()&&_.pos_type===AD_POS.POS_AD_BEFORE_VIDEO||r||_.pos_type===AD_POS.POS_AD_AFTER_VIDEO?i.push(_):a.push(_);
}
return{
oldAdInfos:a,
newAdInfos:i,
...
var a=document.createElement("iframe"),i=getExpParaVal(t,"widget_gray_iframe_path"),n=i?i+"/":"",o=AD_CONFIG.AD_FRAME_DOMAIN+"/tmpl/"+n+"base_tmpl.html";
a.src=o,a.className="iframe_ad_container",a.createIframeTime=Date.now(),e.appendChild(a),
...
try{
localStorage.setItem("__WXLS_ad_iframe_url",o);
}catch(p){}
return a;
}
}
...
var a=t.app_info.app_size||0,i=t.app_info.app_name||t.app_info.appname||"",n=t.app_info.apk_url||t.app_info.pkgurl||"",o=t.app_info.file_md5||t.app_info.pkgmd5||t.app_info.app_md5||"",_=t.app_info.apk_name||t.app_info.pkg_name||"";
...
t.app_info.type=t.type,t.app_info.adid=t.aid,t.app_info.file_md5=o;
var p=utils.extend({
...
var i=a.app_info.app_size||0,n=a.app_info.app_name||a.app_info.appname||"",o=a.app_info.apk_url||a.app_info.pkgurl||"",_=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",p=a.app_info.apk_name||a.app_info.pkg_name||"",r=a.app_info.category,d=["万","百万","亿"],s=a.app_info.down_count||0;
if(s>=1e4){
s/=1e4;
for(var l=0;s>=10&&2>l;)s/=100,l++;
s=s.toFixed(1)+d[l]+"次";
}else s=s.toFixed(1)+"次";
return r=r?r[0]||"其他":"其他",i=utils.formSize(i),n=utils.formName(n),a.app_info._down_count=s,
a.app_info._category=r,a.app_info.app_size=i,a.app_info.app_name=n,a.app_info.apk_name=p,
...
a.app_info.androiddownurl=o,a.app_info.versioncode=a.app_info.version_code,a.app_info.appinfo_url=a.app_info.appinfo_url,
...
if(o.advertisement_num=t.advertisement_num,window._adRenderData=o,o){
...
if((new AdFrame).handleAdWithFrame(m.newAdInfos,m.midAdDataCount),!o.flag&&o.advertisement_num>0){
var g=o.advertisement_num,A=o.advertisement_info;
...
if(urlParser.getQuery("oldAd")&&(P.use_new_protocol=0),D=P.use_new_protocol,n[T]||(n[T]=0),
n[T]++,D)1==D?T===AD_POS.POS_MID?(c=!0,P=a(P),v=P):0===T?(P=i(P),(E===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||E===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(v=P)):3===T&&(v=P):2==D&&(T===AD_POS.POS_MID?(c=!0,
...
P.image_url=urlParser.addParam(V,"wxfrom","50",!0)),adDatas.ads[utils.getPosKeyDesc(T,n[T]-1)]={
a_info:P,
adData:v
...
var nt="&tid="+P.traceid+"&uin="+uin+"&key="+l+"&ticket="+(P.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+P.adid+"&ad_engine=0&pos_type="+P.pos_type+"&exp_id="+P.exp_info.exp_id+"&exp_value="+P.exp_info.exp_value+"&r="+Math.random();
P.report_param=nt;
}
var ot=require("a/sponsor.js");
new ot({
...
var i=a.err_msg,n=e.querySelector(".js_watermark_text");
i.indexOf("get_install_state:yes")>-1&&P.app_info.url_scheme&&(n.textContent=354==parseInt(t.crt_size)||117==parseInt(t.crt_size)||355==parseInt(t.crt_size)||568==parseInt(t.crt_size)?"Enter":"Open App");
});
...
var nt="&tid="+P.traceid+"&uin="+uin+"&key="+l+"&ticket="+(P.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+P.adid+"&ad_engine=0&pos_type="+pos_type+"&exp_id="+P.exp_info.exp_id+"&exp_value="+P.exp_info.exp_value+"&r="+Math.random();
P.report_param=nt;
...
o>-1&&(a.icon_pos=n.icon_pos||"",a.btn_text=n.btn_text||a.btn_text,a.price=n.aid_list[o].price,
a.sale_text=n.aid_list[o].sale_text,window.__addIdKeyReport("68064",15));
}catch(p){
...
function ad_click(e,t,a,i,n,o,_,p,r,d,s,l,c,m,u,f,g,A,y){
if(!has_click[n]){
has_click[n]=!0;
{
...
var a=handleApp(t,n,idx,mid,biz,r,p,s,d,l,g,o,A);
if(a)return;
}
...
if(y)if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.OUTER_DEST_TYPE)handleH5(t,n,idx,mid,biz,r,p,s,d,l,g);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE)Wxopen_card.openWxopen(l);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.AD_DEST_TYPE)openUrlWithExtraWebview(t);else{
...
}else if("5"==e)openUrlWithExtraWebview("/mp/profile?source=from_ad&tousername="+t+"&ticket="+o+"&uin="+uin+"&key="+key+"&__biz="+biz+"&mid="+mid+"&idx="+idx+"&tid="+n);else{
...
if(i){
var n,o,_=i.adData,p=i.a_info,r=p.pos_type,d=p.pos_type,s=i.ad_engine,l=t.getElementsByClassName("js_ad_opt_list_btn_"+r),c=t.getElementsByClassName("js_complain_btn_"+r);
...
ad_click(l,c,u,g,o,A,y,n,D,d,s,_,T,E,i,r,p,f,v),log("[Ad] ad_click: type="+l+", url="+c+", rl="+u+", apurl="+g+", traceid="+o+", ticket="+A+", group_id="+y+", aid="+n+", pt="+D+", pos_type="+d+", ad_engine="+s);
}
...
var t=_,a=!!e&&e.target,i=t.type,n=p.button_action.jump_url,o=t.rl,l=t.apurl,c=t.tid||p.traceid,m=t.ticket,f=t.group_id,g=t.aid,A=t.pt,y=p.use_new_protocol;
...
return ad_click(i,n,o,l,c,m,f,g,A,d,s,_,O,b,h,T,p,D,y),log("[Ad] ad_click: type="+i+", url="+n+", rl="+o+", apurl="+l+", traceid="+c+", ticket="+m+", group_id="+f+", aid="+g+", pt="+A+", pos_type="+d+", ad_engine="+s),
hideComplainBtns(),!1;
});
...
o=_.tid,n=_.aid,(A&&(p.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||p.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE)||115===g)&&(y=!1),
...
ad_click(r,l,c,m,o,u,f,n,g,d,s,t,y,D,v,P,p,_,A),log("[Ad] ad_click: type="+r+", url="+l+", rl="+c+", apurl="+m+", traceid="+o+", ticket="+u+", group_id="+f+", aid="+n+", pt="+g+", pos_type="+d+", ad_engine="+s),
!1;
}
...
return utils.adOptReport(1,p.pos_type,o,n),mmversion.isWp||mmversion.isIOS||mmversion.isAndroid?JSAPI.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(t){
...
function launchIosAppBackup(e,t,a,i,n,o,_,p,r,d,s,l,c){
...
outer_id:d.outer_id
})):void utils.openWebAppStore(s.app_info.appinfo_url,l):void handleH5(e,t,a,i,n,o,_,p,r,d,s);
}
function handleApp(e,t,a,i,n,o,_,p,r,d,s,l,c){
...
function handleH5(e,t,a,i,n,o,_,p,r,d,s){
...
if(t.push(n.getAttribute("data-src")),a.push(n.src),isVideoFrameHasVid(n,e.vid)){
...
n.adVidFromAppmsg=e.vid,setTimeout(function(){
n.contentWindow?n.contentWindow.adVidFromAppmsg=e.vid:utils.report115849(51),utils.postMessage(n.contentWindow,AD_CONFIG.SEND_AD_VID_ACTION,{
...
this.mapInfoMap(function(a,i,n){
i.contentWindow===e&&(t=n);
}),t){
...
{
var i=this.aInfoMap[a],n=i.iframeEle;
i.aInfo.pos_type===AD_POS.POS_AD_AFTER_VIDEO;
}
this.aInfoMap.hasOwnProperty(a)&&n&&(!t||t&&t===a)&&e&&e(i.aInfo,n,i);
}
...
var n=this.iframes[i],o=offset.getOffset(n).offsetTop;
if(("play"===n.contentWindow.videoStatus||"loading"===n.contentWindow.videoStatus)&&a>o&&e<o+n.offsetHeight)return!0;
}
}catch(_){
return!1;
}
...
e.mapInfoMap(function(i,n){
var o=offset.getOffset(n).offsetTop;
postMessageToAdFrame(n.contentWindow,"pageScrollV2",{
bodyScrollTop:t,
adOffsetTop:o,
screenHeight:a,
...
return o?void(n=!1):(_++,r>=i-_&&p.createAdWebview(),void e());
},1e3);
}
function t(){
...
i=t.duration,"play"===t.state&&!n&&e());
});
}
var a=this,i=void 0,n=void 0,o=!1,_=0,p=this,r=10;
JSAPI.on("onMPVideoStateChange",function(e){
"play"===e.state?(t(),o=!1):o=!0,a.reportAdAfterVideo(e);
}),t();
...
var i=a.action,n=a.value||{};
if(i===AD_CONFIG.AD_VIDEO_PLAY_ACTION&&n.playAd&&utils.report115849(35),i===AD_CONFIG.AD_VIDEO_PLAY_ACTION&&(n.vid||n.aid))return n.playAd&&utils.report115849(25),
e.mapInfoMap(function(e,t){
e.vid&&e.vid===n.vid||e.aid===n.aid?e.vid===n.vid&&(postMessageToAdFrame(t.contentWindow,AD_CONFIG.AD_PLAY_VIDEO_ACTION,""),
n.playAd&&utils.report115849(21)):postMessageToAdFrame(t.contentWindow,"pauseVideoV2","");
...
p&&1==!!p.length&&l&&(p=p[0].innerHTML,x.content_length=l.htmlSize),window.logs.pageinfo=x,
function(){
...
if(B=1*T.get(H),!window.__second_open__){
var t=location.href.indexOf("scrolltodown")>-1,o=j.js_cmt_area;
if(t&&o&&o.offsetTop){
var i=o.offsetTop;
window.scrollTo(0,i-25);
}else window.scrollTo(0,B),b.saveSpeeds({
uin:uin,
pid:"https:"==E?462:417,
speeds:{
sid:36,
time:Math.ceil(B/y.getInnerHeight())
}
}),b.send();
}
...
var e=a();
z.set(N,e,+new Date+864e7);
},1e3);
}
var l=I.getData("spad");
l&&l.spad&&_(l.spad.val),e.hasSpAd&&window.setInterval(function(){
d();
var e=r();
...
B=window.pageYOffset,T.set(H,B,+new Date+72e5);
},500);
...
var e=[];
for(var t in O)O.hasOwnProperty(t)&&(window.networkType&&"wifi"==window.networkType&&!S&&i(t)&&(S=!0),
e.push(t));
return O={},e.join(",");
}
function a(){
{
var e,t=window.pageYOffset||document.documentElement.scrollTop,o=j.js_content,i=y.getInnerHeight(),a=j.screen_width,s=j.scroll_height,d=Math.ceil(s/i),r=Math.ceil((o.scrollHeight||o.offsetHeight)/i),_=(window.logs.read_height||t)+i,m=j.pageEndTop,w=j.imgs,c=Math.ceil(_/i)||1,l=j.media,g=50,h=0,f=0,v=0,b=0,T=_+g>m?1:0;
...
e.img_cnt=h||0;
},I=window.appmsgstat||{},O=window.logs.img||{},E=window.logs.pagetime||{},A=O.load||{},k=O.read||{},D=[],B=[],H=0,M=0,N=0;
...
for(var P=0,R=D.length;R>P;++P){
var G=D[P];
G&&G.isCDN()&&(-1!=G.indexOf("/0")&&H++,-1!=G.indexOf("/640")&&M++,-1!=G.indexOf("/300")&&N++);
}
var e={
report_bizuin:biz,
title:j.title,
...
window.logs.idkeys){
var Y=window.logs.idkeys,K=[];
for(var L in Y)if(Y.hasOwnProperty(L)){
var U=Y[L];
U.val>0&&K.push(L+"_"+U.val);
}
e.idkey=K.join(";");
}
z(!!l&&l.getElementsByTagName("img")),z(w);
var J=(new Date).getDay(),V=n();
return(S||0!==user_uin&&Math.floor(user_uin/100)%7==J)&&(e.domain_list=V),S&&(e.html_content=p),
...
function s(e){
k||(k=!0,z.remove(N),e.report_time=parseInt(+new Date/1e3),c({
...
video_cnt:0,
item_show_type:0
},T=new g("page_pos"),z=new g("time_on_page"),I=new g("spad"),x={},O={},E=window.location.protocol,S=!1,A=["wap.zjtoolbar.10086.cn","125.88.113.247","115.239.136.61","134.224.117.240","hm.baidu.com","c.cnzz.com","w.cnzz.com","124.232.136.164","img.100msh.net","10.233.12.76","wifi.witown.com","211.137.132.89","qiao.baidu.com","baike.baidu.com"],k=!1,D=null,B=0,H=[biz,sn,mid,idx].join("_"),M=Math.random(),N=[biz,sn,mid,idx,M].join("_"),q=h.isAndroid&&h.gtVersion("7.0.4",!0)||h.isIOS&&h.gtVersion("7.0.4",!0);
return{
init:t
};
